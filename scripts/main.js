...
const username = "dat.phantien";
const token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJkYXQucGhhbnRpZW4iLCJhdXRoIjoiUk9MRV9VU0VSIiwiTEFTVF9MT0dJTl9USU1FIjoxNjUzMzgzNDg1OTEzLCJleHAiOjE2NTUxODM0ODV9.DTDJFrhZlePWUYr3Zjo6c0FUvAPdB4i9TJf56gonIzykz81dX9GeeMfU3H-veWK4PQZ89Tp2wPVjs1-spwLjDw";
...
function StartTurn(param) {
	...
	setTimeout(function() {
		...
		let enemyHeroDieWhenAttack = botPlayer.checkEnemyHPToAttack();

		//TODO check enemy hero HP versus front hero attack
...
function SendSwapGemKill(swap) {
	let indexSwap =  swap ? swap.getIndexSwapGem() : grid.recommendSwapGemSword();
