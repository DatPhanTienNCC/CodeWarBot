class Player
{
    ...
    anyHeroFullMana() {
        ...
        // let heros = arr.filter(hero => hero.id == "CERBERUS");
        // heros.forEach(hero => {
        //     console.log(hero.id);
        // });
        //Check if Cerberrus then use skill
        // if(hero.length !== 0) {
        //     console.log("using cer");
        //     return hero;
        // }
        // //Check if Fire Spririt then use skill
        // hero = arr.filter(hero => hero.id == "FIRE_SPIRIT");
        // if(hero.length !== 0) {
        //     console.log("using fire");
        //     return hero;
        // }
